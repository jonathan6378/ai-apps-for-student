      ...
      <div className="container-width">
        ...
        >
          ...
          <div className="relative z-10 px-6 sm:px-12 py-16 sm:py-20 text-center">
            ...
            >
              Join 50,000+ students already using StudyGenie to ace their exams. Start free, no credit card required.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <Link
                href="/dashboard"
                className="bg-white text-brand-600 font-bold px-8 py-4 rounded-2xl text-lg hover:bg-white/90 hover:scale-105 active:scale-95 transition-all shadow-xl"
              >
                Get Started Free →
              </Link>
    ...
    <footer className="border-t border-white/5 py-12 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-brand-500 to-accent-pink flex items-center justify-center">
                <span className="text-sm">✨</span>
              </div>
              <span className="text-lg font-bold gradient-text">StudyGenie</span>
            </div>
            <p className="text-dark-400 text-sm">AI-powered study companion for students who want to learn faster.</p>
          </div>
          <div>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-dark-500 text-sm">&copy; 2024 StudyGenie. All rights reserved.</p>
